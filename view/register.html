        ...
        <div class="col-md-9">
          <div class="container-fluid">
            ...
            <div class="buttons mb-4 clearfix">
              <button class="btn submit-subjects"><i class="fas fa-paper-plane mr-2"></i><span>Submit</span></button><a class="btn current-pg float-right" href="current-term.html"><i class="fas fa-list mr-2"></i><span>Current Term</span></a>
            </div>
          </div>
        </div>
        <div class="col-md-3">
