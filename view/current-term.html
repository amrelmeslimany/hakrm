  ...
  <body>
    ...
    <section class="page-content">
      <div class="row no-gutters">
        <div class="col-md-9">
          <div class="container-fluid">
            <h1 class="text-center mt-4 mb-1 sub-cur">Subjects Of This term</h1><small class="text-center d-block mb-3 current-pr">Subjects You Will Take Them In This Term</small>
            <div class="table-responsive table-current-tr mb-2">
              <table class="table">
                <thead class="thead-1">
                  <tr>
                    <th>Subject</th>
            ...
            <div class="buttons mb-4 clearfix">
              <button class="btn print-table"><i class="fas fa-print mr-2"></i><span>Print</span></button><a class="btn history-pg float-right" href="history.html"><i class="fas fa-history mr-2"></i><span>History</span></a>
            </div>
          </div>
        </div>
        <div class="col-md-3">
